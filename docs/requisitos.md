...
| Identificador | Descrição | Prioridade | Origem | Requisitos Relacionados |
| :------------ | :-------- | :--------- | :----- | :---------------------- |
...
| Identificador | Descrição | Prioridade | Origem | Requisitos Relacionados |
| :------------ | :-------- | :--------- | :----- | :---------------------- |
| **RNF01** | O sistema deve apresentar interface geoespacial acessível e intuitiva para navegação em mapas interativos. | Could Have | US01, US02, US06 | RF01, RF02, RF06 |
| **RNF02** | O sistema deve implementar autenticação segura e controle de acesso baseado em perfis (Cidadão, Secretário e Gestor). | Must Have | US05, US06, US09 | RF05, RF06, RF09 |
| **RNF03** | O sistema deve prover APIs de integração para captura automática de dados externos e envio a órgãos parceiros. | Won't Have | US08, US09 | RF08, RF09 |
| **RNF04** | O sistema deve manter registro histórico auditável com data e hora de todas as alterações de status e encaminhamentos. | Must Have | US01, US03, US09, US10| RF01, RF03, RF09, RF10 |
| **RNF05** | O sistema deve manter o tempo de resposta adequado durante a renderização do mapa e interações simultâneas. | Could Have | US02, US04 | RF02, RF04 |